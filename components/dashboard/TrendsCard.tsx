...
export function TrendsCard({ trends }: TrendsCardProps) {
  ...
  return (
    <div className="bg-card rounded-[20px] p-6 border border-border-subtle">
      <div className="mb-6">
        <h3 className="text-lg font-bold text-foreground">Trends deze Maand</h3>
        <p className="text-sm text-text-secondary">Belangrijkste veranderingen</p>
      </div>
        ...
        {trends.map((trend) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-foreground text-sm">{trend.label}</p>
