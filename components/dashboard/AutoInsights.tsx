...
export function AutoInsights({ insights }: AutoInsightsProps) {
  return (
    <div className="bg-white rounded-[20px] p-6 shadow-sm shadow-gray-100 border border-gray-100">
      <div className="mb-6">
        <h3 className="text-lg font-bold text-[#111827]">Automatische Inzichten</h3>
        <p className="text-sm text-gray-500">Gegenereerde inzichten op basis van uw data</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <h4 className="font-semibold text-[#111827] text-sm">{insight.title}</h4>
