  ...
  return (
    <div className="bg-white rounded-[20px] p-6 shadow-sm shadow-gray-100 border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-[#111827]">Cliënten Overzicht</h3>
        <span className="text-sm text-gray-500">{filteredClients.length} cliënten</span>
      </div>
              ...
              >
                <td className="py-3 px-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-medium text-gray-900">{client.naam}</span>
                  </div>
                </td>
                <td className="py-3 px-4 text-sm text-gray-500">{client.email}</td>
                <td className="py-3 px-4 text-sm text-gray-700">{client.bewindvoerder}</td>
                <td className="py-3 px-4 text-sm text-gray-700">{client.stad}</td>
                <td className="py-3 px-4">
                  <span
